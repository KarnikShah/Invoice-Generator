...
$html1 .= ' <tr>
                                        ...
                                        if ($final['qty'] != '5 Kg') {
                                            $html1 .= '' . $final['qty'] . '  Packets<br>';
                                        } else {
                                            $html1 .= '' . $final['qty'] . '  Pouches<br>';
                                        }
                                        $html1.='
                                        ' . $final['brand_name'] . '<br>
...
if(isset($_GET['type']) && $_GET['type']=='download'){
    ...
    //     echo smtp_mailer('test@gmail.com','Invoice For Recent Purchase',$pdf,"Thank you for purchasing items from Mas Packaging. Invoice of purchase items is attached in the email. If you have any queries please free to contact us.");
    // }
?>